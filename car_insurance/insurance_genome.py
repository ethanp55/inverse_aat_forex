...
class RfGenome(Genome):
    ...
    def save_data(self) -> None:
        ...
        scaler_file = './data/insurance_genetic_rf_scaler.pickle'
        rf_file = './data/insurance_genetic_rf.pickle'
        features_file = './data/insurance_genetic_rf_features.pickle'
    ...
    def feature_names(self) -> List[str]:
        feature_names = pickle.load(open('./data/iaat_insurance_training_features.pickle', 'rb'))
...
class GeneticHelper(object):
    ...
    @staticmethod
    def n_features() -> int:
        training_data = np.array(pickle.load(open('./data/iaat_insurance_training_data.pickle', 'rb')))
